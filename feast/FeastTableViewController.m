...
- (id)initWithCoder:(NSCoder *)aCoder{
    ...
    if (self) {
        ...
        self.parseClassName = @"Feast";
        
        // The key of the PFObject to display in the label of the default cell style
        self.textKey = @"name2";
        
        // The title for this table in the Navigation Controller.
        self.title = @"Your Feasts";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
    ...
    int available = [[object objectForKey:@"time"] intValue];
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"%@ & %@",[object objectForKey:@"name1"],[object objectForKey:@"name2"]];
    cell.detailTextLabel.text = [NSString stringWithFormat:@"%@ at: %@", timeRange, [object objectForKey:@"location"]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath* )indexPath{
    ...
    [self performSegueWithIdentifier:@"seeFeast" sender:self];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([[segue identifier] isEqualToString:@"seeFeast"]) {
        ...
        FeatsViewController *destViewController = segue.destinationViewController;
        
        destViewController.tableEntity = self.selected;
        
        NSLog(@"%@", [self.selected objectForKey:@"type"]);
